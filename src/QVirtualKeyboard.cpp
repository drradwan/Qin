...
QVirtualKeyboard::QVirtualKeyboard(QWidget* parent, QinEngine* im, QLineEdit* le)
:QWidget(parent)
{
  /* setup UI */
  setupUi(this);
...
void QVirtualKeyboard::s_on_btn_clicked(int btn) {
  ...
  if (keyId == Qt::Key_Backspace) {
    ...
    QApplication::postEvent(lineEdit, new QKeyEvent(QKeyEvent::KeyPress, keyId, Modifier, QChar(uni)));
    qDebug() << "Adding keypress: " << keyId;
    QApplication::postEvent(lineEdit, new QKeyEvent(QKeyEvent::KeyRelease, keyId, Modifier, QChar(uni)));
...
void QVirtualKeyboard::s_on_btnCands_clicked(int btn) {
  ...
  //lineEdit->insert(key_press.text());
  //QApplication::sendEvent(lineEdit, &key_press);
  QApplication::postEvent(lineEdit, new QKeyEvent(QKeyEvent::KeyPress, keyId, Qt::NoModifier, candButtons[btn]->text()));
  QApplication::postEvent(lineEdit, new QKeyEvent(QKeyEvent::KeyRelease, keyId, Qt::NoModifier, candButtons[btn]->text()));
